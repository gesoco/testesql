...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    testandoSQLLiteAuthUserSubject.add(
      TestandoSQLLiteAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<TestandoSQLLiteAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  TestandoSQLLiteAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = TestandoSQLLiteAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    testandoSQLLiteAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
  ...
  Future initialize() async {
    ...
    try {
      ...
      userData = _prefs.getString(_kUserDataKey) != null
          ? UserLoginStruct.fromSerializableMap(
...
TestandoSQLLiteAuthUser? currentUser;
